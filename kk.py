...
with sr.Microphone() as source:
    ...
    if "star" in command:
        ...
        print("Closing")
        engine_talk("Thank You For Asking Me!! See you Soon.if you want to ask more, press F5 key.")
        ...
        print("Closing")
        engine_talk("Thank You For Asking Me!! See you Soon.")
    elif "sun" in command:
        import pygame
        ...
        img = pygame.image.load("Images/animal of space.jpg")
        ...
        print("Sorry I couldn't understand it. Pardon me by pressing F5 key.")
        engine_talk("Sorry, I couldn't understand it. Pardon me by pressing F5 key.")